        ...
        <div style="display: flex; gap: 16px; align-items: center;">
          ${auth 
            ? `
              ...
              <button id="logout-btn-nav" class="nav-cta" style="background:transparent; color:#ff0033; border-color:transparent;">LOGOUT</button>
              `
            : `
              <a href="/login" class="nav-link ${path === '/login' ? 'active' : ''}" style="font-size:0.8rem;">Login</a>
    ...
    <section class="hero animate-fade-in">
      ...
      <div class="container">
        <div class="hero-content">
          <span class="hero-tagline">Event Curators & Art House</span>
          ...
          <div class="hero-actions">
            ...
            <a href="/apply" class="btn btn-secondary">Apply for Grid Entry</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section-alt">
      <div class="container">
        <div class="section-header">
          ...
          <h2 class="section-title">Experiential Logistics & Event Design</h2>
        ...
        <div class="services-grid">
          ...
          <div class="service-card">
            ...
            <h3 class="service-name">Precision Control</h3>
          ...
          <div class="service-card">
            <div class="service-icon">🎟️</div>
            <h3 class="service-name">Prestige Gate Operations</h3>
        ...
        <div class="phil-layout">
          <div class="phil-visual">
            ...
            <div class="phil-overlay">
              ...
              <p style="font-size:0.85rem; color:#ccc;">Mechanical sculpture in constant motion. Every rev, every slip is a deliberate artistic expression.</p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="form-layout">
          <div>
            ...
            <p>Interested in launching a brand activation, sponsoring our next motorsport spectacle, or commissioning our event coordination services? Send us your brand specs.</p>
          ...
          <div>
            <form id="partner-form" class="card-form">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <select id="interests" class="form-control" style="background:#151515;">
  ...
  if (form) {
    form.onsubmit = async (e) => {
      ...
      try {
        ...
        if (res.ok) {
          feedback.textContent = 'Inquiry transmitted successfully. Our creative leads will contact you in 48 hours.';
          feedback.className = 'form-feedback success';
          form.reset();
        } else {
          feedback.textContent = data.message || 'Transmission failed. Please verify fields and try again.';
...
function renderEventCaseStudy(container) {
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:160px;">
      <div class="container">
        <div class="section-header" style="max-width:800px; margin-bottom:60px;">
          <span class="section-label">Motorscape 2026 • Case Study</span>
          <h1 class="hero-title" style="font-size:clamp(2rem, 6vw, 4rem); line-height:1;">OWN THE NIGHT</h1>
          <p style="font-size:1.15rem; margin-top:20px;">A detailed review of our latest nocturnal showcase. Executed at HopUp Chandigarh, blending precision vehicle grid setups, industrial lighting displays, and professional drifting.</p>
        ...
        <div class="case-stats animate-fade-in">
          ...
          <div class="stat-item">
            ...
            <div class="stat-label">Curated Supercars</div>
          </div>
          <div class="stat-item">
          ...
          <div class="stat-item">
            ...
            <div class="stat-label">Social Impressions</div>
          </div>
        </div>
        ...
        <div class="form-layout" style="margin-bottom:80px;">
          <div>
            <h3 style="font-size:1.8rem; text-transform:uppercase; margin-bottom:20px;">Nocturnal Grid Integration</h3>
            <p style="margin-bottom:20px;">Motorscape 2026 was curated to challenge the conventional "car meet" model. The venue, HopUp Chandigarh, was transformed into an industrial gallery using ambient red spotlight grids and low-frequency sonic setups.</p>
          ...
          <div>
            <h3 style="font-size:1.8rem; text-transform:uppercase; margin-bottom:20px;">Chronological Protocols</h3>
            <ul style="list-style:none; padding:0;">
              <li style="margin-bottom: 20px; border-left: 2px solid var(--accent); padding-left: 20px;">
                <h4 style="color:#fff;">Rolling Entries</h4>
                <p style="font-size:0.9rem;">Controlled timing intervals of high-performance arrivals, keeping spectators engaged safely.</p>
              </li>
              <li style="margin-bottom: 20px; border-left: 2px solid var(--accent); padding-left: 20px;">
                <h4 style="color:#fff;">Exhaust Showcases</h4>
                <p style="font-size:0.9rem;">Acoustic monitoring of engine displacement, rev acoustics, and exhaust flame mechanics.</p>
              </li>
              <li style="margin-bottom: 20px; border-left: 2px solid var(--accent); padding-left: 20px;">
                <h4 style="color:#fff;">Drift taxi runs</h4>
                <p style="font-size:0.9rem;">Professional drivers carrying passengers in dynamic slip angles, demonstrating slip choreography.</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="section-header" style="margin-bottom:40px;">
          <h2 style="font-size:1.8rem; text-transform:uppercase;">Spectator Tier Analytics</h2>
          <p>The event concluded with all tickets sold out within 72 hours of open registration.</p>
        </div>
        <div style="background:var(--bg-secondary); border:1px solid var(--border-color); border-radius:var(--border-radius); overflow:hidden;">
          <table style="width:100%; border-collapse:collapse; text-align:left; font-size:0.9rem;">
            <thead>
              <tr style="border-bottom:1px solid var(--border-color); background:rgba(255,255,255,0.02);">
                <th style="padding:18px 24px;">Tier Class</th>
                <th style="padding:18px 24px;">Event Access</th>
                <th style="padding:18px 24px;">Closing Rate</th>
                <th style="padding:18px 24px; text-align:right;">Status</th>
              </tr>
            </thead>
            <tbody>
              <tr style="border-bottom:1px solid rgba(255,255,255,0.03);">
                <td style="padding:18px 24px; font-weight:700; color:#fff;">Basic Showcase Pass</td>
                <td style="padding:18px 24px; color:var(--text-secondary);">General Access & Entry</td>
                <td style="padding:18px 24px; color:var(--text-secondary);">₹899</td>
                <td style="padding:18px 24px; text-align:right; color:var(--accent); font-weight:700;">CLOSED</td>
              </tr>
              <tr style="border-bottom:1px solid rgba(255,255,255,0.03);">
                <td style="padding:18px 24px; font-weight:700; color:#fff;">Paddock Pass</td>
                <td style="padding:18px 24px; color:var(--text-secondary);">Inner Paddock Grid & Driver Access</td>
                <td style="padding:18px 24px; color:var(--text-secondary);">₹2,099</td>
                <td style="padding:18px 24px; text-align:right; color:var(--accent); font-weight:700;">CLOSED</td>
              </tr>
              <tr style="border-bottom:1px solid rgba(255,255,255,0.03);">
                <td style="padding:18px 24px; font-weight:700; color:#fff;">VIP Pass</td>
                <td style="padding:18px 24px; color:var(--text-secondary);">Lounge Access, VIP Deck & Merch Kit</td>
                <td style="padding:18px 24px; color:var(--text-secondary);">₹4,599</td>
                <td style="padding:18px 24px; text-align:right; color:var(--accent); font-weight:700;">CLOSED</td>
              </tr>
            </tbody>
          </table>
    ...
    <section class="section animate-fade-in" style="padding-top:160px;">
      <div class="container">
        <div class="section-header" style="max-width:700px; margin-bottom:60px;">
          <span class="section-label">Grid Entry Applications</span>
        ...
        <div class="form-layout">
          <div>
            <h3 style="font-size:1.8rem; text-transform:uppercase; margin-bottom:20px;">Entry Protocols</h3>
            ...
            <ul style="list-style:none; padding:0; display:flex; flex-direction:column; gap:20px;">
              <li style="display:flex; gap:16px;">
                <div style="color:var(--accent); font-size:1.3rem;">✓</div>
                <div>
                  <strong style="color:#fff; display:block; text-transform:uppercase; font-size:0.9rem;">1. Clean Presentation</strong>
              ...
              <li style="display:flex; gap:16px;">
                <div style="color:var(--accent); font-size:1.3rem;">✓</div>
                <div>
                  <strong style="color:#fff; display:block; text-transform:uppercase; font-size:0.9rem;">2. Mechanical Verification</strong>
              ...
              <li style="display:flex; gap:16px;">
                <div style="color:var(--accent); font-size:1.3rem;">✓</div>
                <div>
                  <strong style="color:#fff; display:block; text-transform:uppercase; font-size:0.9rem;">3. Safe Operation</strong>
                  <span style="font-size:0.85rem; color:var(--text-secondary);">Drivers must comply with staging marshals. Burnout/drift demos are restricted to active demo periods only.</span>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            <form id="apply-form" class="card-form" enctype="multipart/form-data">
              <h3 style="font-size:1.25rem; text-transform:uppercase; margin-bottom:24px; border-bottom:1px solid var(--border-color); padding-bottom:12px;">Specifications Form</h3>
              ...
              <!-- Vehicle Spec -->
              <h4 style="font-size:0.9rem; text-transform:uppercase; color:var(--accent); margin: 32px 0 16px; border-bottom:1px solid rgba(255,0,51,0.15); padding-bottom:8px;">Machine Profile</h4>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <label class="form-label">VIN / License Plate</label>
                  <input type="text" id="veh_vin" required class="form-control" placeholder="e.g. CH01AB1234">
                </div>
              </div>

              <div class="form-group">
                <label class="form-label">Modifications List</label>
              ...
              <div class="form-group">
                <label class="form-label">Machine Photo (Minimum 1 Required)</label>
                <input type="file" id="app_photos" required multiple accept="image/*" class="form-control" style="background:#151515; padding: 10px;">
                <span style="font-size:0.75rem; color:var(--text-muted); margin-top:4px; display:block;">Supported: JPG, PNG, WEBP. Max size 5MB.</span>
              </div>

              <div class="form-group" style="margin-top:24px;">
                <label class="form-label" style="margin-bottom:16px;">Safety Commitments</label>
                <div style="display:flex; flex-direction:column; gap:12px; font-size:0.85rem;">
                  ...
                  <label style="display:flex; gap:10px; align-items:flex-start; cursor:pointer;">
                    ...
                    <span>I agree to park and operate the vehicle only in designated active grid spots.</span>
                  </label>
                  <label style="display:flex; gap:10px; align-items:flex-start; cursor:pointer;">
              ...
              <button type="submit" id="apply-submit" class="btn btn-primary" style="width:100%; margin-top:24px;">Submit Specifications</button>
  ...
  if (form) {
    form.onsubmit = async (e) => {
      ...
      try {
        ...
        submitBtn.disabled = false;
        submitBtn.textContent = 'Submit Specifications';
      }
    };
  }
}
    ...
    <section class="section animate-fade-in" style="padding-top:160px;">
      <div class="container">
        <div class="section-header" style="max-width:750px; margin-bottom:60px;">
          <span class="section-label">Media & Creative Platform</span>
        ...
        <div class="form-layout">
          <div>
            <h3 style="font-size:1.8rem; text-transform:uppercase; margin-bottom:20px;">Collaboration Options</h3>
            ...
            <div style="font-size:0.9rem; line-height:1.6; color:var(--text-secondary);">
              <div id="creator-guide" class="tab-pane active">
                <h4 style="color:#fff; text-transform:uppercase; margin-bottom:10px;">Content Creator guidelines</h4>
              ...
              <div id="press-guide" class="tab-pane">
                <h4 style="color:#fff; text-transform:uppercase; margin-bottom:10px;">Press & Media Agency guidelines</h4>
          ...
          <div>
            <!-- Creator Form -->
            <form id="creator-apply-form" class="card-form tab-pane active">
              <h3 style="font-size:1.2rem; text-transform:uppercase; margin-bottom:24px; color:var(--accent);">Creator Application</h3>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="form-label">Primary Content Style</label>
                <select id="cre_style" class="form-control" style="background:#151515;">
              ...
              <div class="form-group">
                <label class="form-label">Event Coverage Concept / Pitch</label>
            ...
            <!-- Press Form -->
            <form id="press-apply-form" class="card-form tab-pane">
              <h3 style="font-size:1.2rem; text-transform:uppercase; margin-bottom:24px; color:var(--accent);">Press & Agency Application</h3>
              <div class="form-group">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <select id="press_type" class="form-control" style="background:#151515;">
              ...
              <div class="form-group">
                <label class="form-label">Verifiable Publication / Portfolio Link</label>
...
async function renderCareers(container) {
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:160px;">
      <div class="container">
        <div class="section-header" style="max-width:700px; margin-bottom:60px;">
          <span class="section-label">Operations Registry</span>
        ...
        <div id="careers-loading" style="text-align:center; color:var(--text-secondary); margin:40px 0;">QUERYING VACANCIES...</div>
    ...
    <div id="job-modal" style="position:fixed; inset:0; z-index:2000; background:rgba(0,0,0,0.85); display:none; align-items:center; justify-content:center; padding:20px; backdrop-filter:blur(8px); -webkit-backdrop-filter:blur(8px);">
      <div class="card-form" style="max-width:600px; width:100%; max-height:90vh; overflow-y:auto; position:relative;">
        <button id="close-job-modal" style="position:absolute; top:20px; right:20px; background:transparent; border:none; color:#ff0033; font-size:1.5rem; cursor:pointer;">×</button>
        <h3 id="modal-job-title" style="font-size:1.35rem; text-transform:uppercase; margin-bottom:8px;">Position Application</h3>
        <p id="modal-job-meta" style="font-size:0.8rem; color:var(--text-muted); margin-bottom:24px;"></p>
        ...
        <form id="job-apply-form">
          ...
          <div class="form-group">
            <label class="form-label">Resume Link (e.g. Google Drive/Dropbox PDF)</label>
          ...
          <button type="submit" id="job-submit" class="btn btn-primary" style="width:100%;">Transmit Application</button>
  ...
  try {
    ...
    jobsContainer.innerHTML = jobsList.map(job => `
      <div class="career-card animate-fade-in">
        ...
        <p style="font-size:0.9rem; margin-bottom:20px;">${job.description}</p>
        <div class="career-meta">
          <span>Salary: ${job.salary || 'Varies'}</span>
        </div>
        <button class="btn btn-secondary apply-job-btn" data-id="${job.id}" data-title="${job.title}" data-meta="${job.type} • ${job.location}" style="padding:10px 20px; font-size:0.75rem;">Apply Now</button>
      </div>
    `).join('');
...
async function renderBlogList(container) {
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:160px;">
      <div class="container">
        ...
        <div id="blog-loading" style="text-align:center; color:var(--text-secondary); margin:40px 0;">QUERYING CHRONICLES...</div>
        <div class="careers-grid" id="blogs-container" style="display:none;"></div>
      </div>
    </section>
  `;
  ...
  try {
    ...
    blogsContainer.innerHTML = blogs.map(post => {
      ...
      return `
        <div class="career-card animate-fade-in" style="cursor:pointer;" onclick="window.history.pushState({}, '', '/blog/${post.slug}'); window.handleRouting();">
          <span class="career-dept">${date} • Article</span>
          <h3 class="career-title" style="margin-bottom:12px; font-size:1.35rem; color:#fff;">${post.title}</h3>
          <p style="font-size:0.85rem; color:var(--accent); text-transform:uppercase; font-weight:700; letter-spacing:0.05em; display:flex; align-items:center; gap:8px;">Read Article <span>→</span></p>
        </div>
      `;
    }).join('');
...
async function renderBlogPost(container, slug) {
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:160px; min-height:80vh;">
      <div class="container" style="max-width:800px;">
        <a href="/blog" class="nav-link" style="margin-bottom:40px; display:inline-block; font-size:0.8rem; letter-spacing:0.1em; color:var(--accent);">← BACK TO BLOG</a>
        
        <div id="post-loading" style="text-align:center; color:var(--text-secondary); margin:40px 0;">DECODING CHRONICLE...</div>
        <div id="post-content-area" style="display:none;">
          <h1 id="post-title" class="hero-title" style="font-size:clamp(1.8rem, 5vw, 3rem); line-height:1.1; margin-bottom:20px; text-transform:uppercase;"></h1>
          <div id="post-date" style="font-size:0.85rem; color:var(--text-muted); text-transform:uppercase; margin-bottom:48px; border-bottom:1px solid var(--border-color); padding-bottom:16px;"></div>
          
          <div id="post-body" style="line-height:1.8; color:var(--text-secondary); font-size:1.05rem;" class="markdown-body"></div>
        </div>
      </div>
    </section>
  `;
  ...
  const contentEl = document.getElementById('post-content-area');
...
function renderLogin(container) {
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:160px; min-height:80vh; display:flex; align-items:center;">
      <div class="container" style="max-width:480px; width:100%;">
        <form id="login-form" class="card-form">
          <h2 class="hero-title" style="font-size:1.8rem; text-transform:uppercase; margin-bottom:8px; border-bottom:1px solid var(--border-color); padding-bottom:16px;">Sign In</h2>
          <p style="font-size:0.8rem; color:var(--text-muted); margin-bottom:24px;">Enter your credentials to access tickets, register vehicles, and apply for roles.</p>
          ...
          <button type="submit" id="login-submit" class="btn btn-primary" style="width:100%;">Access Profile</button>
          <div id="login-feedback" class="form-feedback"></div>

          <div style="margin-top:24px; text-align:center; font-size:0.85rem; color:var(--text-secondary);">
            Don't have a profile? <a href="/signup" style="color:var(--accent); font-weight:700;">Register Now</a>
          </div>
        </form>
      </div>
    </section>
  ...
  if (form) {
    form.onsubmit = async (e) => {
      ...
      try {
        ...
        submit.disabled = false;
        submit.textContent = 'Access Profile';
      }
    };
  }
}
    ...
    <section class="section animate-fade-in" style="padding-top:160px; min-height:80vh; display:flex; align-items:center;">
      <div class="container" style="max-width:520px; width:100%;">
        <form id="signup-form" class="card-form">
          <h2 class="hero-title" style="font-size:1.8rem; text-transform:uppercase; margin-bottom:8px; border-bottom:1px solid var(--border-color); padding-bottom:16px;">Create Profile</h2>
          <p style="font-size:0.8rem; color:var(--text-muted); margin-bottom:24px;">Register to access tickets, apply for grid slots, and explore vacancies.</p>
...
async function renderProfile(container) {
  ...
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:160px; min-height:85vh;">
      <div class="container">
        <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid var(--border-color); padding-bottom:24px; margin-bottom:48px; flex-wrap:wrap; gap:20px;">
          <div>
            ...
            <p style="font-size:0.85rem; color:var(--text-secondary); margin-top:8px;">Classification: <strong style="color:var(--accent); text-transform:uppercase;">${auth.user.role}</strong></p>
          </div>
          <div style="display:flex; gap:16px;">
            <a href="/tickets" class="btn btn-primary" style="padding:12px 24px; font-size:0.75rem;">My Passes</a>
            <button id="logout-btn-profile" class="btn btn-secondary" style="padding:12px 24px; font-size:0.75rem;">Logout</button>
          </div>
        </div>

        <div class="form-layout">
          <div>
            <h3 style="font-size:1.35rem; text-transform:uppercase; margin-bottom:20px;">Registered Machines</h3>
          ...
          <div>
            <h3 style="font-size:1.35rem; text-transform:uppercase; margin-bottom:20px;">Upcoming Staging</h3>
            <div style="background:var(--bg-secondary); border:1px solid var(--border-color); padding:32px; border-radius:var(--border-radius); text-align:center;">
              <h4 style="font-size:1rem; text-transform:uppercase; color:#fff; margin-bottom:12px;">Motorscape 2026 Completed</h4>
              <p style="font-size:0.85rem; margin-bottom:20px;">The HopUp Chandigarh grid showcase has completed. Stay updated for future session schedules.</p>
              <a href="/event" class="btn btn-secondary" style="font-size:0.75rem; padding:10px 20px;">View Event Recap</a>
            </div>
          </div>
        </div>
      </div>
  ...
  try {
    ...
    if (res.ok && data.success && data.vehicles && data.vehicles.length > 0) {
      vehContainer.innerHTML = data.vehicles.map(v => `
        <div style="background:var(--bg-secondary); border:1px solid var(--border-color); padding:24px; border-radius:var(--border-radius); display:flex; justify-content:space-between; align-items:center;">
          <div>
            <h4 style="color:#fff; font-size:1.1rem; text-transform:uppercase; margin-bottom:4px;">${v.car.year} ${v.car.make} ${v.car.model}</h4>
            <p style="font-size:0.8rem; color:var(--text-muted);">Plate: ${v.car.vin}</p>
          </div>
          <span style="font-size:0.75rem; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:${v.status === 'approved' ? '#2ecc71' : v.status === 'rejected' ? '#e74c3c' : '#f1c40f'}">${v.status}</span>
        </div>
      `).join('');
    } else {
      vehContainer.innerHTML = `
        <div style="border:1px dashed var(--border-color); padding:32px; border-radius:var(--border-radius); text-align:center; color:var(--text-muted);">
    ...
    vehLoading.style.display = 'none';
    vehContainer.innerHTML = `<div style="color:#e74c3c; font-size:0.9rem;">Failed to fetch registered garage vehicles.</div>`;
  }
}
    ...
    <section class="section animate-fade-in" style="padding-top:160px; min-height:85vh;">
      <div class="container" style="max-width:800px;">
        <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid var(--border-color); padding-bottom:24px; margin-bottom:48px;">
          <div>
            <span class="section-label">Spectator Registry</span>
            <h1 class="hero-title" style="font-size:2.5rem; line-height:1; text-transform:uppercase;">Active Passes</h1>
          </div>
          <a href="/profile" class="btn btn-secondary" style="font-size:0.75rem; padding:12px 20px;">Back to Profile</a>
        </div>

        <div id="tickets-loading" style="text-align:center; color:var(--text-secondary);">RETRIEVING PASS CODES...</div>
  ...
  try {
    ...
    if (res.ok && data.success && data.data && data.data.length > 0) {
      containerEl.innerHTML = data.data.map(ticket => {
        const eventDate = new Date(ticket.event.eventDate).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric' });
        return `
          <div style="background:linear-gradient(135deg, var(--bg-panel) 0%, #0c0c0c 100%); border:1px solid var(--border-color); border-left:4px solid var(--accent); padding:32px; border-radius:var(--border-radius); display:flex; justify-content:space-between; gap:24px; flex-wrap:wrap; position:relative; overflow:hidden;">
            <!-- Subtle glow accent -->
            <div style="position:absolute; top:0; right:0; width:150px; height:150px; background:radial-gradient(circle at 100% 0%, rgba(var(--accent-rgb), 0.1) 0%, transparent 70%); z-index:0;"></div>
            
            <div style="position:relative; z-index:1; flex:1;">
              <span style="font-size:0.7rem; font-weight:700; color:var(--accent); letter-spacing:0.2em; text-transform:uppercase;">${ticket.tier.name}</span>
              <h3 style="font-size:1.6rem; color:#fff; text-transform:uppercase; margin:8px 0 12px; font-family:var(--font-display);">${ticket.event.name}</h3>
              <div style="display:flex; flex-direction:column; gap:6px; font-size:0.85rem; color:var(--text-secondary);">
                ...
                <div style="margin-top:12px; font-size:0.75rem; color:var(--text-muted); text-transform:uppercase; letter-spacing:0.05em;">Code: ${ticket.ticketCode}</div>
              </div>
            </div>

            <div style="display:flex; flex-direction:column; justify-content:space-between; align-items:flex-end; min-width:140px; relative; z-index:1;">
              <span style="font-size:0.75rem; font-weight:700; text-transform:uppercase; padding:6px 12px; background:rgba(46, 204, 113, 0.1); border:1px solid #2ecc71; color:#2ecc71; border-radius:4px;">${ticket.status}</span>
              
              <!-- Simulated barcode -->
              <div style="text-align:center; margin-top:20px; width:100%;">
                <div style="height:36px; background:repeating-linear-gradient(90deg, #fff, #fff 2px, #000 2px, #000 6px); border-radius:2px; margin-bottom:8px;"></div>
                <a href="/api/ticket-pdf/${ticket.ticketCode}" target="_blank" class="btn btn-secondary" style="font-size:0.7rem; padding:8px 12px; width:100%; text-align:center;">Download PDF</a>
              </div>
            </div>
          </div>
        `;
      ...
      containerEl.innerHTML = `
        <div style="border:1px dashed var(--border-color); padding:48px; border-radius:var(--border-radius); text-align:center; color:var(--text-muted);">
          No spectator passes found. 
          <p style="font-size:0.85rem; margin-top:12px;">Motorscape 2026 is concluded. Keep checking for upcoming events.</p>
        </div>
      `;
    }
    ...
    loadingEl.style.display = 'none';
    containerEl.innerHTML = `<div style="color:#e74c3c; text-align:center;">Failed to query spectator tickets.</div>`;
  }
}
  ...
  container.innerHTML = `
    <section class="section animate-fade-in" style="padding-top:200px; min-height:80vh; display:flex; align-items:center; text-align:center;">
      <div class="container" style="max-width:600px;">
        ...
        <h1 class="hero-title" style="font-size:3rem; line-height:1; margin-bottom:24px;">Grid Blocked</h1>
...
function parseMarkdown(md) {
  return md
    ...
    .replace(/</g, '&lt;')
    .replace(/>/g, '&gt;')
    .replace(/^### (.*$)/gim, '<h3 style="color:#fff; font-size:1.25rem; margin:24px 0 12px; text-transform:uppercase;">$1</h3>')
    .replace(/^## (.*$)/gim, '<h2 style="color:#fff; font-size:1.5rem; margin:32px 0 16px; text-transform:uppercase;">$1</h2>')
    .replace(/^# (.*$)/gim, '<h1 style="color:#fff; font-size:1.80rem; margin:36px 0 20px; text-transform:uppercase;">$1</h1>')
    .replace(/\*\*(.*)\*\*/gim, '<strong style="color:#fff;">$1</strong>')
    .replace(/\*(.*)\*/gim, '<em>$1</em>')
    .replace(/\[([^\]]+)\]\(([^)]+)\)/gim, '<a href="$2" style="color:var(--accent); font-weight:700;">$1</a>')
